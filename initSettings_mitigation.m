function settings = initSettings_mitigation()
...
settings.msToProcess        =400000;        %[ms]
settings.ms                 = 1;
...
settings.dir                = 'E:\TEXBAT\postResult\ds6'; % F:\TEXBAT
...
settings.mitigation = 0; % normal tracking
% settings.mitigation = 1; % spoofing mitigation after steady MLE
%%
...
settings.INSAT = 0;
settings.multiCorrOn = 0;
settings.multiCorrDistribution  =  -2:0.05:2;
